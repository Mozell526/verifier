...
CONFIG = {
    "projects": ["marketting-planning-intent", "QA", "client_search", "marketting-planning", "deerflow", "policy_search"],
    "case_counts": {"marketting-planning-intent": 4, "QA": 4, "client_search": 10, "deerflow": 4, "policy_search": 4},
    "required_cases": {
