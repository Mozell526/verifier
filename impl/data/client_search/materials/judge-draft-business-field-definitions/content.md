...
- evidence_ref: `business-field-definitions`
- location: `business://src/main/python/data/client_search_query_parse/field_definitions_args.yaml`
- source_revision: `a2cfd68ea351d5081d95857ca7bcbfac90434528`
- source_sha256: `852bc94ee6d2e1dda549ef5e950a59ab71e44d2b49d14361deec2368e4c878f2`

字段级承载关系、操作符、值类型与示例：哪些字段承载什么意图、支持什么操作符与换算规则（如 clientAge 支持 GTE/LTE/RANGE/EXISTS/NOT_EXISTS；familyclientbirthday 字段定义现声明 RANGE/GT/GTE/LT，enhanced_rules 仍出现 LTE/EXISTS 的未裁决面）。
